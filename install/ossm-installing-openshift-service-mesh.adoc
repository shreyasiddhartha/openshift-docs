...
[WARNING]
====
Running {SMProduct} 3 and {SMProduct} 2 in the same cluster causes conflicts unless configured correctly. Make sure you are not running {SMProduct} 2 on your cluster before proceeding. See, xref:../migrating/ossm-migrating-read-me-assembly.adoc#ossm-migrating-read-me-assembly[Migrating from {SMProduct} 2.6] if you are migrating from {SMProduct} 2.
====
