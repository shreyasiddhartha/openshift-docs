...
Z (Patch version or z-stream release):: delivers critical bug fixes and security updates, such as CVE resolutions. Patch versions do not include new features.
